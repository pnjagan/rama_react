...
import {mLogoutMeta} from '../../state/actions';
...
const useStyles = makeStyles(theme => ({
    ...
    mainCanvas : {
      ...
      margin : `0px ${theme.spacing(2)}px ${theme.spacing(2)}px ${theme.spacing(2)}px`
...
function ContentIndex(props) {
  ...
  const logoutHandler = (e)=> {
    ...
    log('LOGOUT META ACTION',mLogoutMeta({}));
    dispatch (
      mLogoutMeta({})
    );
  }
      ...
      {/* User drop down */}
              ...
              <Paper>
                <ClickAwayListener onClickAway={handleUserMenuClose}>
                  <MenuList autoFocusItem={userMenuOpen} id="menu-list-grow" onKeyDown={handleListKeyDown} >
                    <MenuItem className={classes.userMenuItem} >Preferences </MenuItem>
                    <MenuItem onClick={logoutHandler} className={classes.userMenuItem} >logout </MenuItem>
                  </MenuList>
                </ClickAwayListener>
              </Paper>
            </Grow>
        ...
        <Grid container spacing={3} style={{}}>
          ...
          <Grid item xs={12} sm={6} md={3} lg={2}>
               ...
               <Paper elevation={2} className={classes.floatingCard} onClick={ (e) =>{ e.preventDefault(); log('Clicked Items'); }} >

                  <Typography  variant="h6"  className={classes.cardHeading} align='center'>
                    Invoice
                  </Typography>  
          ...
          <Grid item xs={12} sm={6} md={3} lg={2}>
               <Paper elevation={2} className={classes.configCard} >
                  ...
                  <Link href="#" onClick={(e)=>{e.preventDefault() ;log('CLicked Params')}} className={classes.submenuLink}>

                    <Typography align='center'>Parameters</Typography>
                  
                  </Link>

                  <Link href="#" onClick={(e)=>{e.preventDefault()}} className={classes.submenuLink}>
